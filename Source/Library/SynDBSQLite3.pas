...
function TSQLDBSQLite3ConnectionProperties.ColumnTypeNativeToDB(
...
const
  SQLITE3_FIELDS: TSQLDBFieldTypeDefinition = (
...
begin
  ...
  fSQLCreateField := SQLITE3_FIELDS;
  fSQLCreateFieldMax := 0; // SQLite3 doesn't expect any field length
  fUseCache := true;
end;
...
function TSQLDBSQLite3Statement.ColumnType(Col: integer): TSQLDBFieldType;
begin
